...
def create_sar_ice_label_colormap():
  """Creates a label colormap used in sar_ice segmentation benchmark.
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _sar_ice:
    return create_sar_ice_label_colormap()
  else:
