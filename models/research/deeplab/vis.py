...
flags.DEFINE_multi_integer('vis_crop_size', [129, 129],
...
flags.DEFINE_multi_integer('atrous_rates', [1,2,3],
                           'Atrous rates for atrous spatial pyramid pooling.')

flags.DEFINE_integer('output_stride', 65,
...
flags.DEFINE_string('dataset', 'sar_ice',
                    'Name of the segmentation dataset.')

flags.DEFINE_string('exp', '100',
                    'Experiment id.')
...
flags.DEFINE_enum('colormap_type', 'pascal', ['pascal', 'cityscapes','sar_ice'],
...
to_output_logits_sihl = []
to_output_logits_stmoritz = []
to_output_logits_sils = []
to_output_logits_silvaplana = []
precision = dict()
recall = dict()
...
def main(unused_argv):
  ...
  with g.as_default():
      ...
      with sv.managed_session(FLAGS.master,
        ...
        for batch in range(num_batches):
          ...
          _process_batch(sess=sess,
                         ...
                         semantic_predictions=predictions, raw_predictions=raw_predictions, logits=logits, exp=exp,
    ...
    np.save("deeplab/datasets/sar_ice/exp_{}/logits/logits_sils".format(exp),to_output_logits_sils)
    np.save("deeplab/datasets/sar_ice/exp_{}/logits/logits_silvaplana".format(exp),to_output_logits_silvaplana)
    np.save("deeplab/datasets/sar_ice/exp_{}/logits/logits_stmoritz".format(exp),to_output_logits_stmoritz)
    np.save("deeplab/datasets/sar_ice/exp_{}/logits/logits_sihl".format(exp),to_output_logits_sihl)
